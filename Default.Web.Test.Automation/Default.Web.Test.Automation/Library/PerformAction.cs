...
namespace Default.Web.Test.Automation.Library
{
	 ...
	 */
        ...
        //Wait explicitly to check the presence of element
        public void waitIfElementPresent(IWebElement element,int seconds)
        {
        ...
        public String getBrowserVersion()
        {
            ...
            if (browserName.Equals("chrome") || browserName.Contains("internet"))
            {
                browserVersion = capabilities.GetCapability("version").ToString();
            } else 
            {
